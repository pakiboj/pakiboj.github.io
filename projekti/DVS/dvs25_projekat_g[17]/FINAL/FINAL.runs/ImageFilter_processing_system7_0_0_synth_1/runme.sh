...
HD_PWD='C:/MIHAJLO/faks/dvs/projekat/FINAL/FINAL.runs/ImageFilter_processing_system7_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ImageFilter_processing_system7_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ImageFilter_processing_system7_0_0.tcl
