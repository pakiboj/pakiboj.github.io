...
HD_PWD='C:/MIHAJLO/faks/dvs/projekat/FINAL/FINAL.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ImageFilter_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ImageFilter_wrapper.tcl
