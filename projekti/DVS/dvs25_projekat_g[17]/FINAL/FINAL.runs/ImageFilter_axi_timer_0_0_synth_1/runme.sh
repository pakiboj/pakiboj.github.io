...
HD_PWD='C:/MIHAJLO/faks/dvs/projekat/FINAL/FINAL.runs/ImageFilter_axi_timer_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ImageFilter_axi_timer_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ImageFilter_axi_timer_0_0.tcl
