...
HD_PWD='C:/MIHAJLO/faks/dvs/projekat/FINAL/FINAL.runs/ImageFilter_auto_us_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ImageFilter_auto_us_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ImageFilter_auto_us_1.tcl
