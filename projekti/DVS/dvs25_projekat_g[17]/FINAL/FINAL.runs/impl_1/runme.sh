...
HD_PWD='C:/MIHAJLO/faks/dvs/projekat/FINAL/FINAL.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ImageFilter_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ImageFilter_wrapper.tcl -notrace
