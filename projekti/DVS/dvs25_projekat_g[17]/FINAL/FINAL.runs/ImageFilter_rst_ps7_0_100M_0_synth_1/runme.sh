...
HD_PWD='C:/MIHAJLO/faks/dvs/projekat/FINAL/FINAL.runs/ImageFilter_rst_ps7_0_100M_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ImageFilter_rst_ps7_0_100M_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ImageFilter_rst_ps7_0_100M_0.tcl
